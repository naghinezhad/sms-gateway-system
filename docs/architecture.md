...
- پشتیبانی از حجم بسیار بالا (تا 100 میلیون پیامک در روز).
- مدیریت توزیع نامتوازن ترافیک مشتریان.
- مسیر اکسپرس با SLA مشخص.
- کنترل سختگیرانه موجودی کیف پول.
- ارائه گزارش های دقیق پیامک ها.

### تصمیمات کلیدی

- کنترل موجودی با تراکنش و قفل ردیف کیف پول برای جلوگیری از مصرف بیش از موجودی.
- مسیر اکسپرس با تاپیک جدا و دیسپچر جدا برای کاهش صف.
- پارتیشن بندی بر اساس `customer_id` برای حفظ ترتیب هر مشتری.
- قفل توزیع شده در Redis برای جلوگیری از پردازش تکراری.
- ثبت نقض SLA اکسپرس بر اساس زمان قبول تا ارسال به اپراتور.

### نکات مقیاس پذیری

- افزایش تعداد پارتیشن های Kafka و تعداد دیسپچرها.
- اجرای جداگانه دیسپچرهای استاندارد و اکسپرس.
- استفاده از outbox در صورت نیاز به انتشار دقیقا-یکبار.
